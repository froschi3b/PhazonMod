...
public class EntityPlasma extends Entity implements IProjectile {
    ...
    public EntityPlasma(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    public void onUpdate() {
        ...
        if (i > 0) {
            ...
            if (axisalignedbb != null && axisalignedbb.isVecInside(this.worldObj.getWorldVec3Pool().getVecFromPool(this.posX, this.posY, this.posZ))) {
                this.onHitGround(this.xTile, this.yTile, this.zTile);
            }
        }
        ...
        if (movingobjectposition != null) {
            if (movingobjectposition.entityHit != null) {
                ...
                this.playSound("random.bowhit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                this.onHitGround(xTile, yTile, zTile);
