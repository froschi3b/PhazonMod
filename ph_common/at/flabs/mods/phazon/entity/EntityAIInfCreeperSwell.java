...
public class EntityAIInfCreeperSwell extends EntityAIBase
{
    /** The creeper that is swelling. */
    EntityInfCreeper swellingCreeper;
    ...
    public EntityAIInfCreeperSwell(EntityInfCreeper par1EntityCreeper)
    {
